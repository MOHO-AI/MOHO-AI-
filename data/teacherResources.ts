...
- **'mermaid'**: للخرائط الذهنية والرسوم البيانية الهيكلية. **هام:** يجب **دائماً** وضع النصوص العربية داخل علامتي اقتباس مزدوجتين (" "). مثال: \`graph TD; A["نص عربي"]\`.
...
`,
  ...
  lessons: {
    "subjects": {
      ...
      "اللغة الإنجليزية": [
        { "title": "شرح دروس الوحدة 1 للأستاذة بن جدو رشا", "url": "https://www.dzexams.com/uploads/documents/dzexams-docs-4am-908814.pdf" }
      ],
      "الرياضيات": [
